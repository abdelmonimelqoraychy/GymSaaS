...
const resources = {
  fr: {
    translation: {
      ...
      dashboard: {
        ...
        description: "L’essentiel de l’activité de votre salle en un coup d’œil.",
      ...
      legal: {
        kicker: "INFORMATIONS GYMSAAS",
        noticeTitle: "Mentions légales",
        privacyTitle: "Politique de confidentialité",
        subtitle: "Informations relatives au site de démonstration GymSaaS.",
        publisherTitle: "Éditeur du service",
        publisherText: "GymSaaS est présenté par Abdelmonim El Qoraychy. Vous pouvez nous contacter par e-mail ou par téléphone.",
        purposeTitle: "Objet du site",
        purposeText: "Ce site présente une démonstration de GymSaaS, une solution de gestion destinée aux salles de sport. Les informations affichées dans les comptes de démonstration sont fictives.",
        hostingTitle: "Hébergement technique",
        hostingText: "L’interface web est déployée sur Vercel et le service applicatif sur Railway. Ces prestataires assurent l’infrastructure technique de la démonstration.",
        dataTitle: "Données concernées",
        dataText: "Le formulaire de contact peut recueillir votre nom, votre adresse e-mail, votre numéro de téléphone, le sujet et le contenu de votre demande. Un compte créé sur la plateforme contient les informations que vous renseignez volontairement.",
        usageTitle: "Utilisation des données",
        usageText: "Ces informations servent uniquement à traiter les demandes, fournir les fonctions de la démonstration et sécuriser son fonctionnement. N’utilisez pas de données réelles ou sensibles dans les comptes de test.",
        requestsTitle: "Vos demandes",
        requestsText: "Pour demander l’accès, la correction ou la suppression d’informations vous concernant, contactez-nous par e-mail ou par téléphone.",
        back: "← Retour au site",
      },
    },
  },
  ...
  closeMenu:
    "إغلاق القائمة",
      ...
      legal: {
        kicker: "معلومات GYMSAAS",
        noticeTitle: "المعلومات القانونية",
        privacyTitle: "سياسة الخصوصية",
        subtitle: "معلومات متعلقة بموقع GymSaaS التجريبي.",
        publisherTitle: "الجهة المسؤولة عن الخدمة",
        publisherText: "يقدّم Abdelmonim El Qoraychy خدمة GymSaaS. يمكنكم التواصل معنا عبر البريد الإلكتروني أو الهاتف.",
        purposeTitle: "هدف الموقع",
        purposeText: "يقدّم هذا الموقع نسخة تجريبية من GymSaaS، وهي منصة لإدارة الأندية الرياضية. جميع المعلومات المعروضة في الحسابات التجريبية وهمية.",
        hostingTitle: "الاستضافة التقنية",
        hostingText: "واجهة الموقع مستضافة على Vercel والخدمة التطبيقية على Railway، وهما يوفران البنية التقنية للنسخة التجريبية.",
        dataTitle: "البيانات المعنية",
        dataText: "قد يجمع نموذج الاتصال الاسم والبريد الإلكتروني ورقم الهاتف وموضوع الرسالة ومحتواها. يحتوي الحساب المنشأ على المعلومات التي تقدمها طوعاً.",
        usageTitle: "استخدام البيانات",
        usageText: "تُستخدم هذه المعلومات لمعالجة الطلبات وتوفير وظائف النسخة التجريبية وتأمينها. لا تستخدم بيانات حقيقية أو حساسة في حسابات الاختبار.",
        requestsTitle: "طلباتكم",
        requestsText: "لطلب الوصول إلى معلوماتكم أو تصحيحها أو حذفها، تواصلوا معنا عبر البريد الإلكتروني أو الهاتف.",
